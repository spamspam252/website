            ...
            <div class="row">
              ...
              <section class="ArticleTitle-expand col-md-8 col-sm-12 hidden-sm"><a href="<?php echo 'post.php?id='.$post[4];?>">
                ...
                <div class="ArticleText-expand">
                  <p class="ArticleText"><?php echo substr($post[3],0,330).'...';?></p><a href="<?php echo 'post.php?id='.$post[4];?>">READ POST<span class="glyphicon glyphicon-menu-right"></span></a>
                </div>
              </section>
        ...
        <div class="section">
          <article class="Article">
            <div class="row">
              ...
              <div class="BlogImage"><img src="../img/articleimg1.jpg" alt="Nope" class="col-md-4 col-sm-12"/></div>
